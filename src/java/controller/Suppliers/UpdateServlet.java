...
import helpers.Suppliers.SuppliersUpdate;
 ...
 * @author KsS
 */
@WebServlet(name = "SuppliersUpdateServlet", urlPatterns = {"/Suppliers/updateSupplier"})
public class UpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       SuppliersUpdate cu= new SuppliersUpdate();
        cu.doUpdate(supplier);
